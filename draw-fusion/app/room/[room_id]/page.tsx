...
const UsernamePage = ({
  ...
  return (
    <section className="flex flex-col justify-center antialiased bg-black text-gray-600 min-h-screen p-4">
      <div className="h-full">
        <div className="max-w-[360px] mx-auto">
          <div className="bg-gray-500 shadow-lg rounded-lg mt-9">
            ...
            <div className="bg-gray-800 text-center px-5 py-6">
              <form className="space-y-3" onSubmit={handleJoinRoom}>
                ...
                <button
                  type="submit"
                  className="font-semibold text-sm inline-flex items-center justify-center px-3 py-2 border border-transparent rounded leading-5 shadow transition duration-150 ease-in-out w-full bg-violet-500 hover:bg-violet-600 text-white focus:outline-none focus-visible:ring-2"
                >
                  Start Fun
                </button>
              </form>
